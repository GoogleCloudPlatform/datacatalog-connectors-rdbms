...
setuptools.setup(
    ...
    entry_points={
        'console_scripts': [
            'google-datacatalog-saphana-connector = google.datacatalog_connectors.saphana:main',
        ],
    },
    include_package_data=True,
    install_requires=('hdbcli', 'google-datacatalog-rdbms-connector>=0.12.0<0.13.0'),
