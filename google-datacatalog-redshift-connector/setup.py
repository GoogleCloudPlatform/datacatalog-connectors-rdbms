...
setuptools.setup(
    ...
    entry_points={
        'console_scripts': [
            'google-datacatalog-redshift-connector = google.datacatalog_connectors.redshift:main',
        ],
    },
    include_package_data=True,
    install_requires=('google-datacatalog-postgresql-connector>=0.10.0<0.11.0'),
    setup_requires=(
        'pytest-runner',
    ),
    tests_require=(
