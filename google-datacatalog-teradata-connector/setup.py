...
setuptools.setup(
    ...
    entry_points={
        'console_scripts': [
            'google-datacatalog-teradata-connector = google.datacatalog_connectors.teradata:main',
        ],
    },
    include_package_data=True,
    install_requires=('teradatasql', 'google-datacatalog-rdbms-connector>=0.12.0<0.13.0'),
