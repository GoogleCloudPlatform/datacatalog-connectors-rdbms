...
# named teradata2dc-datacatalog-credentials.json.
ENV GOOGLE_APPLICATION_CREDENTIALS=/data/teradata2dc-credentials.json
...
ENTRYPOINT ["google-datacatalog-teradata-connector"]
