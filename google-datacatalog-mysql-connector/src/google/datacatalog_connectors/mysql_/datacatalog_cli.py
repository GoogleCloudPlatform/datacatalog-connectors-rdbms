...
class MySQL2DatacatalogCli(datacatalog_cli.DatacatalogCli):
    ...
    def _get_user_config_path(self):
        return os.path.join(
            os.getcwd(), 'google-datacatalog-mysql-connector/ingest_cnfg.yaml')
    ...
    def _parse_args(self, argv):
        ...
        parser.add_argument(
            ...
            'path (If supplied ignores the mysql server credentials)')
