...
SQL_OBJECT_ITEM_QUERY_FILENAME_KEY = 'query_filename'
SQL_OBJECT_ITEM_QUERY_FILENAME_PREFIX = 'query'
SQL_OBJECT_ITEM_QUERY_FILENAME_SUFFIX = 'sql_object.json'

SQL_OBJECT_ITEM_METADATA_DEF_FILENAME_KEY = 'metadata_def_filename'
SQL_OBJECT_ITEM_METADATA_DEF_FILENAME_PREFIX = 'metadata_def'
